    ...
    <>
      ...
      <section className={` min-h-screen bg-no-repeat bg-cover bg-center w-full fixed z-10 transition-all duration-1000 ${cover ? 'top-0' : '-top-[150%]'} `} style={{ backgroundImage: `url('../assets/Bg2.png')` }}>
        <div className=" justify-center items-center flex flex-col min-h-screen">
          <div className=" font-italiana text-8xl text-[#84A0BC] mt-5 text-center" data-aos="fade-up">Nadia & Dyan</div>
          <div className=" font-cormorant text-xl italic mt-5" data-aos="fade-down">Kepada YTH.</div>
          <div className=" font-cormorant text-3xl" data-aos="fade-down">Tamu Undangan</div>
          <button data-aos="zoom-in-up" onClick={() => handleCover()} className=" p-2 px-5 text-sm bg-[#BBAFC7] text-white rounded-full mt-5 border border-[#BBAFC7] hover:text-[#BBAFC7] hover:bg-transparent duration-300 focus:outline-none">
            Buka Undangan
          </button>
        </div>
      </section>
